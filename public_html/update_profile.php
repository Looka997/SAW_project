<?php
    ...
    $abort = false;
    // aggiungere dei controlli per addr e phone
    ...
    if (isset($_POST['submit']) && $_SESSION["email"] === $_POST["to_update"]){
        ...
        // if (preg_match($phone_reg, $_POST["phone"]) == 0){
        //     //echo "<h1> phone is not valid </h1>";
        //     $abort = true;
        // }
        // if (preg_match($address_reg, $_POST["address"]) == 0){
        ...
        // TODO
        // ci fa differenza avere stringa vuota nel db o NULL? ora come ora ci finisce NULL
